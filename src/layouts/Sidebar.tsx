...
export function Sidebar({ onNavigate }: SidebarProps) {
  ...
  return (
    <nav
      aria-label="Primary"
      className="flex h-full w-64 flex-col bg-chrome border-r border-chrome-3"
    >
      <div className="h-16 flex items-center px-5 border-b border-chrome-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <div className="font-heading font-semibold text-sm text-off-white">
              Attendance
            </div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  ...
                  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime focus-visible:ring-offset-2 focus-visible:ring-offset-chrome',
                  isActive
                    ? 'bg-chrome-3 text-off-white font-medium'
                    : 'text-muted-gray hover:text-off-white hover:bg-chrome-2 hover:translate-x-0.5',
                )
              }
            >
              <span
      ...
      <div className="p-3 border-t border-chrome-3">
